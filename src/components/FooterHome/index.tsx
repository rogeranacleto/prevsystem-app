...
export function FooterHome(){
    return(
        <footer className="bg-black border-t border-gray-400/20 max-w-screen pb-50 mt-50 pt-30 relative flex items-center justify-center">
            <div className="flex flex-col text-center justify-center" data-aos="fade-left" data-aos-duration="2300">
                <h2 className="text-[#ffffff] font-bold text-4xl">Venha fazer parte disso!</h2>
                <p className="text-gray-400 mt-4">A plataforma é totalmente gratuíta, crie sua conta e comece a utilizar os recursos.</p>
                <Link to={"/signup"}>
                    <button className=" mt-10 text-sm bg-[#3a0eb6] pt-4 pb-4 pl-6 pr-6 font-medium text-black cursor-pointer rounded-sm hover:scale-105 border hover:border-[#3a0eb6] hover:border-solid hover:text-[#3a0eb6] hover:bg-black duration-300 ease-in-out">Acessar Plataforma</button>
                </Link>
            </div>
